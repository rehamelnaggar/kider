    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav mx-auto">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                    ...
                    <a href="{{route('call')}}" class="dropdown-item">Become A Teacher</a>
        ...
        <div class="d-flex align-items-center">
            <div class="language-switcher me-3">
                <button class="btn btn-primary btn-sm me-1" onclick="setLanguage('en')">English</button>
                <button class="btn btn-secondary btn-sm" onclick="setLanguage('ar')">العربية</button>
            </div>
